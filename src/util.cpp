...
void GLErrorCheck(const char* message)
{
    ...
    case GL_INVALID_ENUM:
        spdlog::debug("GL_INVALID_ENUM : {}}\n", message);
        break;
    case GL_INVALID_VALUE:
        spdlog::debug("GL_INVALID_VALUE : {}}\n", message);
        break;
    case GL_INVALID_OPERATION:
        spdlog::debug("GL_INVALID_OPERATION : {}}\n", message);
        break;
#ifndef GL_ES_VERSION_2_0
    case GL_STACK_OVERFLOW:
        spdlog::debug("GL_STACK_OVERFLOW : {}}\n", message);
        break;
    case GL_STACK_UNDERFLOW:
        spdlog::debug("GL_STACK_UNDERFLOW : {}}\n", message);
        break;
#endif
    case GL_OUT_OF_MEMORY:
        spdlog::debug("GL_OUT_OF_MEMORY : {}}\n", message);
        break;
    case GL_NO_ERROR:
        break;
    }
...
{
    spdlog::debug("{}} =\n", name.c_str());
    spdlog::debug("   | %10.5f, %10.5f, %10.5f, %10.5f |\n", m4[0][0], m4[1][0], m4[2][0], m4[3][0]);
...
{
    spdlog::debug("{}} =\n", name.c_str());
    spdlog::debug("   | %10.5f, %10.5f, %10.5f |\n", m3[0][0], m3[1][0], m3[2][0]);
