...
**NOTE: If you are running on a VR headset, please add `--vr 1` in the command line arguments for `gs_streamer` and set the size to match `videoSize` in the headset code.**
